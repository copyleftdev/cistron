...
tandem-repeat indels — and the literal-vs-`ReferenceLengthExpression` state
choice for large repeats matches too (validated against a 2,000-vector
normalization corpus covering both).
